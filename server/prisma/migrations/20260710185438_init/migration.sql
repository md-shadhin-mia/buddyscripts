...
-- CreateEnum
CREATE TYPE "NotificationEntityType" AS ENUM ('POST', 'COMMENT', 'FRIEND_REQUEST', 'EVENT');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('FRIEND_REQUEST', 'FRIEND_ACCEPTED', 'POST_REACTION', 'POST_COMMENT', 'COMMENT_REPLY', 'EVENT_INVITE');

-- CreateEnum
CREATE TYPE "EventAttendeeStatus" AS ENUM ('GOING', 'MAYBE', 'NOT_GOING');
...
-- CreateIndex
CREATE INDEX "StoryViewer_storyId_idx" ON "StoryViewer"("storyId");
...
-- CreateIndex
CREATE INDEX "Event_startDate_idx" ON "Event"("startDate" DESC);
